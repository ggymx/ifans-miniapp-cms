  ...
  <div style="width:80%;min-height:550px;height:auto;margin:0 auto">
    ...
    <div v-show="seleType==1">
      <div class="input-div">
        ...
        <el-input placeholder="请输入标题" v-model="title" clearable class="full"></el-input>
      </div>
      <div class="input-div">
...
export default {
  ...
  methods: {
    ...
    loadTopic() {
      ...
      //     .catch(err => {});
      // }
      this.$data.topicList = this.$store.getters.posts.filter(item => {
        return item.type == 1;
      });
    },
    init() {
